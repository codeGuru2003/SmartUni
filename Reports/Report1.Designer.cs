namespace SmartUni.Reports
{
	partial class Report1
	{
		...
		private void InitializeComponent()
		{
			...
			this.pageInfo1.SizeF = new System.Drawing.SizeF(484.5F, 23F);
			this.pageInfo1.StyleName = "PageInfo";
			// 
			// pageInfo2
			// 
			this.pageInfo2.LocationFloat = new DevExpress.Utils.PointFloat(484F, 0F);
			this.pageInfo2.Name = "pageInfo2";
			this.pageInfo2.SizeF = new System.Drawing.SizeF(484.5F, 23F);
			...
			this.label1.SizeF = new System.Drawing.SizeF(969F, 24.19433F);
			this.label1.StyleName = "Title";
			this.label1.Text = "Entrance Applicant Report";
			// 
			// table1
			// 
			...
			this.tableCell1.Weight = 0.09130208238851667D;
			// 
			// tableCell2
			// 
			this.tableCell2.Name = "tableCell2";
			this.tableCell2.StyleName = "DetailCaption1";
			this.tableCell2.Text = "Middle Name";
			this.tableCell2.Weight = 0.10556652277738809D;
			// 
			// tableCell3
			// 
			...
			this.tableCell3.Weight = 0.089720230968621D;
			// 
			// tableCell4
			// 
			this.tableCell4.Name = "tableCell4";
			this.tableCell4.StyleName = "DetailCaption1";
			this.tableCell4.Text = "Dateof Birth";
			this.tableCell4.Weight = 0.099204316350820762D;
			// 
			// tableCell5
			// 
			this.tableCell5.Name = "tableCell5";
			this.tableCell5.StyleName = "DetailCaption1";
			this.tableCell5.Text = "Hometown State";
			this.tableCell5.Weight = 0.12934293638688D;
			// 
			// tableCell6
			// 
			...
			this.tableCell6.Text = "Numberof Children";
			this.tableCell6.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleRight;
			this.tableCell6.Weight = 0.14677802401799536D;
			// 
			// tableCell7
			// 
			this.tableCell7.Name = "tableCell7";
			this.tableCell7.StyleName = "DetailCaption1";
			this.tableCell7.Text = "Current Address";
			this.tableCell7.Weight = 0.13015127428052842D;
			// 
			// tableCell8
			// 
			this.tableCell8.Name = "tableCell8";
			this.tableCell8.StyleName = "DetailCaption1";
			this.tableCell8.Text = "Phone Number";
			this.tableCell8.Weight = 0.11903657706529364D;
			// 
			// tableCell9
			// 
			this.tableCell9.Name = "tableCell9";
			this.tableCell9.StyleName = "DetailCaption1";
			this.tableCell9.Text = "Nextof Kin";
			this.tableCell9.Weight = 0.088898083004789089D;
			// 
			// table2
			// 
			...
			this.tableCell10.Weight = 0.0913020745150445D;
			// 
			// tableCell11
			// 
			...
			this.tableCell11.Weight = 0.10556651490391593D;
			// 
			// tableCell12
			// 
			...
			this.tableCell12.Weight = 0.089720223095148835D;
			// 
			// tableCell13
			// 
			...
			this.tableCell13.Weight = 0.099204308477348582D;
			// 
			// tableCell14
			// 
			this.tableCell14.ExpressionBindings.AddRange(new DevExpress.XtraReports.UI.ExpressionBinding[] {
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[Hometown_State]")});
			this.tableCell14.Name = "tableCell14";
			this.tableCell14.StyleName = "DetailData1";
			this.tableCell14.Weight = 0.12934292851340784D;
			// 
			// tableCell15
			// 
			this.tableCell15.ExpressionBindings.AddRange(new DevExpress.XtraReports.UI.ExpressionBinding[] {
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[NumberofChildren]")});
			this.tableCell15.Name = "tableCell15";
			this.tableCell15.StyleName = "DetailData1";
			this.tableCell15.StylePriority.UseTextAlignment = false;
			this.tableCell15.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleRight;
			this.tableCell15.Weight = 0.14677802401799536D;
			// 
			// tableCell16
			// 
			this.tableCell16.ExpressionBindings.AddRange(new DevExpress.XtraReports.UI.ExpressionBinding[] {
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[CurrentAddress]")});
			this.tableCell16.Name = "tableCell16";
			this.tableCell16.StyleName = "DetailData1";
			this.tableCell16.Weight = 0.13015126640705624D;
			// 
			// tableCell17
			// 
			...
			this.tableCell17.Weight = 0.11903656919182147D;
			// 
			// tableCell18
			// 
			this.tableCell18.ExpressionBindings.AddRange(new DevExpress.XtraReports.UI.ExpressionBinding[] {
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[NextofKin]")});
			this.tableCell18.Name = "tableCell18";
			this.tableCell18.StyleName = "DetailData1";
			this.tableCell18.Weight = 0.088898114498677766D;
			// 
			// sqlDataSource1
			// 
			...
			table3.Name = "EntranceApplicants";
			columnExpression1.Table = table3;
			column1.Expression = columnExpression1;
			columnExpression2.ColumnName = "StudentId";
			columnExpression2.Table = table3;
			column2.Expression = columnExpression2;
			columnExpression3.ColumnName = "StatusID";
			columnExpression3.Table = table3;
			column3.Expression = columnExpression3;
			columnExpression4.ColumnName = "TitleID";
			columnExpression4.Table = table3;
			column4.Expression = columnExpression4;
			columnExpression5.ColumnName = "ImagePath";
			columnExpression5.Table = table3;
			column5.Expression = columnExpression5;
			columnExpression6.ColumnName = "FirstName";
			columnExpression6.Table = table3;
			column6.Expression = columnExpression6;
			columnExpression7.ColumnName = "MiddleName";
			columnExpression7.Table = table3;
			column7.Expression = columnExpression7;
			columnExpression8.ColumnName = "LastName";
			columnExpression8.Table = table3;
			column8.Expression = columnExpression8;
			columnExpression9.ColumnName = "GenderID";
			columnExpression9.Table = table3;
			column9.Expression = columnExpression9;
			columnExpression10.ColumnName = "DateofBirth";
			columnExpression10.Table = table3;
			column10.Expression = columnExpression10;
			columnExpression11.ColumnName = "Hometown_State";
			columnExpression11.Table = table3;
			column11.Expression = columnExpression11;
			columnExpression12.ColumnName = "NationalityID";
			columnExpression12.Table = table3;
			column12.Expression = columnExpression12;
			columnExpression13.ColumnName = "CountryID";
			columnExpression13.Table = table3;
			column13.Expression = columnExpression13;
			columnExpression14.ColumnName = "ReligionID";
			columnExpression14.Table = table3;
			column14.Expression = columnExpression14;
			columnExpression15.ColumnName = "MaritalStatusID";
			columnExpression15.Table = table3;
			column15.Expression = columnExpression15;
			columnExpression16.ColumnName = "NumberofChildren";
			columnExpression16.Table = table3;
			column16.Expression = columnExpression16;
			columnExpression17.ColumnName = "CurrentAddress";
			columnExpression17.Table = table3;
			column17.Expression = columnExpression17;
			columnExpression18.ColumnName = "PhoneNumber";
			columnExpression18.Table = table3;
			column18.Expression = columnExpression18;
			columnExpression19.ColumnName = "EmailAddress";
			columnExpression19.Table = table3;
			column19.Expression = columnExpression19;
			columnExpression20.ColumnName = "AddressLine1";
			columnExpression20.Table = table3;
			column20.Expression = columnExpression20;
			columnExpression21.ColumnName = "AddressLine2";
			columnExpression21.Table = table3;
			column21.Expression = columnExpression21;
			columnExpression22.ColumnName = "AddressLine3";
			columnExpression22.Table = table3;
			column22.Expression = columnExpression22;
			columnExpression23.ColumnName = "NextofKin";
			columnExpression23.Table = table3;
			column23.Expression = columnExpression23;
			columnExpression24.ColumnName = "OccupationID";
			columnExpression24.Table = table3;
			column24.Expression = columnExpression24;
			columnExpression25.ColumnName = "EmergencyContact";
			columnExpression25.Table = table3;
			column25.Expression = columnExpression25;
			columnExpression26.ColumnName = "RelationshipTypeID";
			...
			selectQuery1.Name = "EntranceApplicants";
            ...
            this.sqlDataSource1});
			this.DataMember = "EntranceApplicants";
